...
* Add config parameter `electricity_grid_connection`, which adds electricity grid connection costs to fixed capital costs for solar and onwind generators in prepare_sector_network [#1810](https://github.com/pypsa-meets-earth/pypsa-earth/issues/1810)
